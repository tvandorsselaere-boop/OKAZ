...
export function geocodeLocation(location: string): GeocodingResult | null {
  ...
  if (postalMatch) {
    ...
    const deptMainCity: Record<string, string> = {
      '01': 'lyon', '02': 'amiens', '03': 'montlucon',
      '04': 'digne-les-bains', '05': 'gap', '06': 'nice',
      '07': 'valence', '08': 'reims', '09': 'toulouse',
      '10': 'troyes', '11': 'perpignan', '12': 'toulouse',
      '13': 'marseille', '14': 'caen', '15': 'clermont-ferrand',
      '16': 'poitiers', '17': 'la rochelle', '18': 'bourges',
      '19': 'limoges', '20': 'ajaccio', '2a': 'ajaccio', '2b': 'bastia',
      '21': 'dijon', '22': 'rennes', '23': 'limoges',
      '24': 'bordeaux', '25': 'besancon', '26': 'valence',
      '27': 'rouen', '28': 'chartres', '29': 'brest',
      '30': 'nimes', '31': 'toulouse', '32': 'toulouse',
      '33': 'bordeaux', '34': 'montpellier', '35': 'rennes',
      '36': 'tours', '37': 'tours', '38': 'grenoble',
      '39': 'besancon', '40': 'pau', '41': 'tours',
      '42': 'saint-etienne', '43': 'clermont-ferrand', '44': 'nantes',
      '45': 'orleans', '46': 'toulouse', '47': 'bordeaux',
      '48': 'montpellier', '49': 'angers', '50': 'caen',
      '51': 'reims', '52': 'dijon', '53': 'rennes',
      '54': 'nancy', '55': 'metz', '56': 'lorient',
      '57': 'metz', '58': 'dijon', '59': 'lille',
      '60': 'amiens', '61': 'caen', '62': 'calais',
      '63': 'clermont-ferrand', '64': 'pau', '65': 'pau',
      '66': 'perpignan', '67': 'strasbourg', '68': 'mulhouse',
      '69': 'lyon', '70': 'besancon', '71': 'dijon',
      '72': 'tours', '73': 'chambery', '74': 'annecy',
      '75': 'paris', '76': 'rouen', '77': 'paris',
      '78': 'versailles', '79': 'poitiers', '80': 'amiens',
      '81': 'toulouse', '82': 'toulouse', '83': 'toulon',
      '84': 'avignon', '85': 'nantes', '86': 'poitiers',
      '87': 'limoges', '88': 'nancy', '89': 'dijon',
      '90': 'mulhouse', '91': 'paris', '92': 'boulogne-billancourt',
      '93': 'montreuil', '94': 'creteil', '95': 'argenteuil',
    };
